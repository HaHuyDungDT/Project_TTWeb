            ...
            <div class="card">
                ...
                <div class="card-content">
                    <div class="progress-wrapper">
                        <p>
                            ...
                            <%} else {%>
                            <span class="float-right">Giảm <%=-ord%>%</span>
                            <%}%>
                        </p>
                        <div class="progress">
                    ...
                    <div class="progress-wrapper">
                        <p>
                            ...
                            <%} else {%>
                            <span class="float-right">Giảm <%=-curr%>%</span>
                            <%}%>
                        </p>
                        <div class="progress">
                ...
                <div class="progress-wrapper">
                    <p>
                        ...
                        <%
                            int rev = (int) (((currentP.getRevenue() - lastP.getRevenue()) / lastP.getRevenue()) * 100);
                            if (rev > 0) {%>
                        <span class="float-right">Tăng <%=rev%>%</span>
                        <%} else {%>
                        <span class="float-right">Giảm <%=-rev%>%</span>
                        <%}%>
                    </p>
                    <div class="progress">
